...
newDir = "raw_packing_data_vqa_5500k-16k-fast"                   # 转 webdataset 之前数据的存放位置 (jpg, json)
SRC_DIR_IMGS = "/data_3/aiak_pretrain_vqa_5500k"   # 原始 img  数据的存放位置
SRC_DIR_JSONS = "/data_3/aiak_pretrain_vqa_5500k"   # 原始 json 数据的存放位置
SRC_DST_EXTENSIONS = ("jpg", "json")
f_toklens_originalsample = os.path.join(target_directory, "token_info_v2_vqa_5500k_s16k.txt")
PACKED_LENGTH = 16384
...
if __name__ == "__main__":
    ...
    bin_boxs = load_bin_boxes("./s2_ckpt/bins_boxs.pkl")
