...
newDir = "raw_packing_data_emova_captions_300k"                   # 转 webdataset 之前数据的存放位置 (jpg, json)
...
f_toklens_originalsample = os.path.join(target_directory, "token_info_captions.txt")
PACKED_LENGTH = 8192
...
n_packed_samples=10  # 测试用，输出几条打包后的数据
...
if __name__ == "__main__":
    ...
    bin_boxs = load_bin_boxes("./s2_ckpt/bins_boxs_emova_captions_8k.pkl")
