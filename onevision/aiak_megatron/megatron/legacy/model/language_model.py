...
class TransformerLanguageModel(MegatronModule):
    ...
    def __init__(
        ...
        args = get_args()
        # TODO: passing share_embeddings_and_output_weights=False will not work correctly for
        # T5 and embeddings will not be synced. Fix later for T5.
        ...
        if self.post_process:
            ...
            if self.untie_embeddings_and_output_weights:
                self.output_layer = tensor_parallel.ColumnParallelLinear(
                    ...
                    bias=False, # Setting bias to False always to keep it consistent with embedding tying
                )
