...
nvlm_yi_34b_template = ("{{- bos_token }}{% for message in messages %}{{'<|im_start|>' + "
...
# Note: this is the same template as https://huggingface.co/meta-llama/Llama-3.1-8B-Instruct/blob/main/
# tokenizer_config.json#L2053
