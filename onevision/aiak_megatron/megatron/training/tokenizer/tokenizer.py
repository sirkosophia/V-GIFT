...
class _HuggingFaceTokenizer(MegatronTokenizer):
    ...
    def __init__(self, pretrained_model_name_or_path, **kwargs):
        ...
        # TODO(bnorick): download tokenizer once to lustre and use force offline to
        # make sure all tasks read it from there
...
class _BertWordPieceTokenizer(MegatronTokenizer):
    ...
    def add_token(self, token):
        """Add a new token into the current vocabulary."""
    ...
    def decode(self, ids):
        """Decodes a sequence of IDs in a single string"""
...
class _SentencePieceTokenizer(MegatronTokenizer):
    ...
    # From:
    # https://github.com/NVIDIA/NeMo/blob/c8fa217e811d60d11d014827c7f3845ff6c99ae7/nemo/collections/common/
    # tokenizers/sentencepiece_tokenizer.py#L89
    def tokenize(self, text):
        """tokenize"""
        ids = []
        idx = 0
    ...
    # From:
    # https://github.com/NVIDIA/NeMo/blob/c8fa217e811d60d11d014827c7f3845ff6c99ae7/nemo/collections/common/
    # tokenizers/sentencepiece_tokenizer.py#L125
