...
class GetDataOnThisCpRank(torch.autograd.Function):
...
class LLaVAModel(MegatronModule):
    ...
    def _preprocess_data(
        ...
        https://github.com/huggingface/transformers/blob/85817d98fb60977c97e3014196a462b732d2ed1a/src/transformers/
        models/llava_next/modeling_llava_next.py#L409
    ...
    def _process_embedding_token_parallel(
        ...
        if self.context_parallel_lm > 1:
            ...
            if packed_seq_params is None or packed_seq_params.qkv_format == 'sbhd':
                ...
                batch = GetDataOnThisCpRank.apply(batch, packed_seq_params)
...
# Based on https://github.com/OpenGVLab/InternVL/blob/c7c5af1a8930b4862afe8ed14672307082ef61fa/internvl_chat/internvl/
# model/internvl_chat/modeling_internvl_chat.py#L218
