...
class RetroDecoderCrossAttention(BaseRetroCrossAttention):
    ...
    ** Note about 'encoder_block_spec' **
    ...
    Args:
        ...
        encoder_block_spec (ModuleSpec): The first Retro decoder layer is provided with a transformer block spec
            to construct the neighbor encoder.
    """
    ...
    def forward(
        ...
        Returns:
            A dict consisting of the attention output and context, along with other scalars necessary for performing
                the downstream bias-dropout-add.
        """
