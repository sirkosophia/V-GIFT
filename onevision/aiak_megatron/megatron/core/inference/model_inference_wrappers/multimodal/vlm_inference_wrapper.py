...
class VLMInferenceWrapper(GPTInferenceWrapper):
    ...
    def get_batch_for_context_window(
        ...
        Args:
            ...
            context_end_position (int): End of the context window. During the last inference step it will mostly be
                the max generated sequence length.
    ...
    def run_one_forward_step(self, inference_input: Dict[str, Any]) -> torch.Tensor:
        """Run one forward step with the provided input."""
        tokens = inference_input["tokens"]
