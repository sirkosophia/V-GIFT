...
class GPTInferenceWrapper(AbstractModelInferenceWrapper):
    ...
    def _build_attention_mask_and_position_ids(
        ...
        Returns:
            Tuple[torch.Tensor, torch.Tensor]: The attention mask of shape [1, 1, max_seq_len, max_seq_len] and
            position ids of shape [batch_size, max_seq_len]
        """
    ...
    def get_batch_for_context_window(
        ...
        This function gets called iteratively in a loop . Given the start and end context positions,
        it extracts the appropriate data.
        ...
        Args:
            ...
            context_end_position (int): End of the context window. During the last inference step it will
                mostly be the max generated sequence length.
