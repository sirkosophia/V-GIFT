...
def get_inference_engine(args: Namespace, model: MegatronModule) -> AbstractEngine:
    ...
    This function will automatically choose the TRTLLMBackend when possible, and default to Mcore backend
    if the user does not specify any backends. TRTLLMBackend is not implmented yet.
