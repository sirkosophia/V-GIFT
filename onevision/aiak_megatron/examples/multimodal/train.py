...
def get_batch(data_iterator, image_token_index, img_seq_len):
    ...
    if args.context_parallel_size > 1 or args.sequence_parallel:
        ...
        tokens, position_ids, labels, loss_mask = [torch.nn.functional.pad(item, (0, mp_padding_needed))
        ...
        packed_seq_params = context_parallel.get_packed_seq_params(tokens, num_image_embeddings,
                                                                   mp_padding_needed, args.context_parallel_size, True)
