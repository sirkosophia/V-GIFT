    ...
    for name, tensor in hf_state_dict.items():
        ...
        if "embeddings.class_embedding" in name:
            ...
            if tensor_parallel_size == 1:
                ...
                # Note: 25 is not divisible by 8 and we don't currently support uneven heads
                # split with tensor parallelism.
            ...
            if "ls1" in name:
                ...
                padded_tensor = torch.zeros((padded_dim, new_tensor.shape[-1]),
                ...
                num_tensors = 1
                padded_dim = head_dim * num_padded_heads * num_tensors
                padded_tensor = torch.zeros((new_tensor.shape[0], padded_dim),
                                            dtype=new_tensor.dtype, device=new_tensor.device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-name", type=str, default="OpenGVLab/InternViT-6B-448px-V1-5",
