...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num-layers-per-pp-rank", type=int, default=None, nargs="*",
    ...
    f(args.input, args.output, args.input_pipeline_parallel, args.output_pipeline_parallel,
      args.tensor_parallel, args.num_layers_per_pp_rank)
