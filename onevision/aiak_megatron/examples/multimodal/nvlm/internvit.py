...
class InternViTRMSNorm(MegatronModule):
    """RMSNorm layer that supports internvit"""
    def __init__(
        self,
        config,
        hidden_size: int,
...
def get_mlp_module_spec(use_te: bool = True) -> ModuleSpec:
    """Get the module specification for the dense MLP."""
...
class InternViTTransformerLayer(TransformerLayer):
    """Intern ViT specific implementation of TransformerLayer"""
...
class InternViTSelfAttention(SelfAttention):
    """Intern ViT specific implementation of SelfAttention"""
    def __init__(
...
def get_internvit_layer_spec(use_te) -> ModuleSpec:
    """Return an InternViT transformer layer spec"""
