...
def get_inference_engine(args: Namespace, model: MegatronModule) -> AbstractEngine:
    ...
    This function will automatically chose the TRTLLMBackend when possible, and if not revert to
    Mcore backend if the user does not specify any backends. TRT LLM Backend is not implmented yet. 
    ...
    text_generation_controller = SimpleTextGenerationController(inference_wrapped_model=inference_wrapped_model,
                                                                tokenizer=tokenizer)
...
def main():
    ...
    # Micro batch size is not needed to be set by user.
    # (It is calculated based on inference-batch-times-seqlen-threshold argument)
