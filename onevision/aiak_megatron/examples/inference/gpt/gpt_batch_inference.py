...
def get_inference_engine(args: Namespace, model: MegatronModule) -> AbstractEngine:
    ...
    text_generation_controller = TextGenerationController(inference_wrapped_model=inference_wrapped_model,
                                                          tokenizer=tokenizer)
...
def main():
    ...
    # Micro batch size is not needed to be set by user. (It is calculated based on
    # inference-batch-times-seqlen-threshold argument)
    initialize_megatron(
