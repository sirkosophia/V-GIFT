...
def get_inference_engine(args: Namespace, model: MegatronModule) -> AbstractEngine:
    ...
    This function will automatically chose the TRTLLMBackend when possible, and if not revert to Mcore backend
    if the user does not specify any backends. TRT LLM Backend is not implmented yet.
