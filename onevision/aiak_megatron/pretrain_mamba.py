...
def model_provider(pre_process=True, post_process=True) -> MambaModel:
    ...
    assert not args.use_legacy_models, "Mamba only supported in Mcore!"
...
def is_dataset_built_on_rank():
    """Check if the dataset is built on the current rank."""
    return (
...
def core_gpt_dataset_config_from_args(args):
    """Core GPT Dataset Config from arguments."""
